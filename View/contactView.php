...
<body class="d-flex text-center demo-5 page">
    ...
    <section class="">
        ...
        <div id="contact" class="container-fluid text-white text-center mt-2">
            <h1 class="titleContact text-uppercase fw-bold mt-3 pt-2">Disponibilité & Contact</h1>
                ...
                <div class="row justify-content-between mx-5">
                    <div class="col-md-4">
                        <div class="d-flex flex-row justify-content-start pt-1">
                            ...
                            <div class="mt-1">
                                <h3 class="text-center text-nowrap">Travail à distance (possible)</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <div class="mt-2">
                                <h3 class="text-center text-nowrap">Disponible à temps plein</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex flex-row justify-content-end pt-1">
                            <div class="me-2">
                                <img id="logo_mail" src="../assets/img/email-3d.png" alt="Logo en 3d d'une icone d'un mail" width="60px">
                            </div>
                            <div class="mt-1">
                                <h3 class="text-center text-nowrap">Réponse rapide assurée</h3>
                            </div>
                        </div>
                    </div>
                </div>
