...
<body class="d-flex text-center demo-5 portfolioBody">
            ...
            <div class="scroll__stage">
                ...
                <section class="portfolio__start vh-100">
                    <p class="section__title-arrow position-absolute top-0 start-50 translate-middle">
                        ...
                        <span class="arrow3">Scroll</span><br>
                    </p>
                </section>
                    <section id="section1" class="section">
                        <div class="section__title text-white">
                            <h1 class="section__title-number">01</h1>
                            <h2 class="section__title-text">Logma</h2>
                            <p class="section__title-arrow">
                                <!-- <span class="arrow1">➤</span><br> 
                                <span class="arrow2">➤</span>
                                <span class="arrow3 fs-2">Scroll</span> -->
                            </p>
                        </div>
                        
                        <div class="section__paragraph text-white">
                            <div class="image-project1 position-relative">
                                <img src="../assets/img/pcPortable.png" alt="Photo d'un PC portable" class="hover-image1">
                            </div>
                            <p> La boule de feu que nous avons chevauchée se déplaçait
                                – Mais maintenant nous avons un nouveau machine – Ils ont de la musique dans le système
                                solaire <br>
                                <a href="" class="section__button">Découvrir</a>
                            </p>
                        </div>
                    </section>
                    ...
                    <section id="section2" class="section">
                        <div class="section__title text-white">
                            ...
                            <h2 class="section__title-text">Naos</h2>
                        </div>
                        <div class="section__paragraph text-white">
                            <div class="image-project2 position-relative">
                                <img src="../assets/img/mobile_tablette.png" alt="photo d'un smartphone avec une tablette" class="hover-image2">
                            </div>
                            <p> Laissez-moi vous emmener faire un petit voyage – Nous
                            allons voyager plus vite que lumière – Et vous irez où vous voulez <br>
                                <a href="" class="section__button">Découvrir</a>
                            </p>
                        </div>
                    </section>
                    ...
                    <section id="section3" class="section">
                        <div class="section__title text-white">
                            ...
                            <h2 class="section__title-text">Chara</h2>
                        </div>
                        <div class="section__paragraph text-white">
                            <div class="image-project3 position-relative">
                                <img src="../assets/img/ecran_PC.png" alt="photo d'un écran d'ordinateur" class="hover-image3">
                            </div>
                            <p> Ferme les yeux maintenant – Et cède à la nuit –
                            Envole-toi au-dessus de la étoiles – Oubliez ce qu’il y a derrière <br>
                                <a href="" class="section__button">Découvrir</a>
                            </p>
                        </div>
                    </section>
                    ...
                    <!-- <div class="work">
                        <div class="work1 group">
                            <div class="workpic">
                                <div class="homework1"><img src="images/londonborn-device.png" width="" height=""
                                        alt=""></div>
                                <div class="homeworksplat">
                                    <div class="fluidbig"
                                        style="border-radius: 839.849px 751.074px 793.413px 870.798px;">
                                    </div>
                                </div>
                            </div>
                            <div class="workintro">
                                <div class="worktext">
                                    <h3 class="hideme">London Born</h3>
                                    <p class="hideme">Aure Wines needed to improve their presence in the Ontario wine
                                        market. And considering the roots of their family-owned winery reached back to
                                        Britain, soon the London Born Wine Company was, well, born. As part of the bold
                                        rebrand, a strong online presence was needed.</p> <a class="cd-btn hideme"
                                        href="londonborn.html#top" data-type="page-transition">View Work</a>
                                </div>
                            </div>
                        </div>
                        <div class="work2 group">
                            ...
                            <div class="workintro2">
                                <div class="worktext2">
                                    <h3 class="hideme">Subaru</h3>
                                    <p class="hideme">This Subaru Dealer was looking to change it up and have a dynamic
                                        site that focused on design and usability. They were looking to help people find
                                        the car they wanted easily. And, in doing so, the Dealer found some strong
                                        results.</p> <a class="cd-btn hideme" href="subaru.html"
                                        data-type="page-transition">View Work</a>
                                </div>
                            </div>
                        </div>
                        <div class="work3 group">
                            <div class="workpic">
                                <div class="homework3"><img src="images/valeyo-device.png" width="" height="" alt="">
                                </div>
                                <div class="homeworksplat">
                                    <div class="fluidbig"
                                        style="border-radius: 839.849px 751.074px 793.413px 870.798px;">
                            ...
                            <div class="workintro hideme">
                                <div class="worktext">
                                    <h3>Valeyo</h3>
                                    <p>Valeyo is more than an insurance provider. They are a SAAS company who needed a
                                        clear and concise way to provide information about its technological offerings
                                        for its prospective clients.</p> <a class="cd-btn hideme" href="valeyo.html#top"
                                        data-type="page-transition">View Work</a>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('.section').mousemove(function(e) {
        ...
        var rotateX1 = -(mouseY / $(this).height() - 0.5) * 30 + 10; // Ajustez le coefficient pour la sensibilité
        var rotateY1 = (mouseX / $(this).width() - 0.5) * 30;
        
        var rotateX2 = -(mouseY / $(this).height() - 0.5) * 30 + 55; // Ajustez le coefficient pour la sensibilité
        var rotateY2 = (mouseX / $(this).width() - 0.5) * 30;
        
        var rotateX3 = -(mouseY / $(this).height() - 0.5) * 30 + 75; // Ajustez le coefficient pour la sensibilité
