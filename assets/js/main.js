$(document).ready(function () {
    ...
    //     $('#loader').fadeIn();
    //     // Faire disparaître le loader après 1300ms (1.3 seconde)
    //     setTimeout(function() {
    //         $('#loader').fadeOut();
    //     }, 2000);
    // });
    ...
    // // Début Personnalisation offcanvas
    ...
    let getRandom = () => {
        let random = Math.floor(Math.random() * 21) + 40;
