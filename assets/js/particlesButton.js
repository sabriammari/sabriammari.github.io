...
(function(global, factory) {
    ...
    Particles.prototype = {
        defaults: {
            ...
            speed: function() { return rand (30); },
            particlesAmountCoefficient: 18,
        ...
        addParticles: function (rect, progress) {
            ...
            var centerX = this.options.canvasPadding + rect.width / 2;
            var centerY = this.options.canvasPadding + rect.height / 2;
            ...
            if (i > 0) {
                while (i--) {
                    var angle = rand(360);
                    var distance = progressValue + Math.random() * rect.width / 2;
    ...
    function rand(value) {
        return Math.random() * value - value / 1;
    }
