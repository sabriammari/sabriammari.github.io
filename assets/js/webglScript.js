...
var texture = new THREE.TextureLoader().load( 'assets/img/starry-night-sky.jpg' , function ( texture ) {
...
var mapHeight = new THREE.TextureLoader().load('assets/img/black-background.jpg', function( texture){
...
var light = new THREE.PointLight(0xffffff, .45, 4,0);
